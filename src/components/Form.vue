  ...
  <div id="app" style="width:800px; margin:0 auto;" class="container-fluid">
    <form class="vue-form " @submit.prevent="postNow">
      ...
      <fieldset>
        ...
        <div>
          <h4>Chọn tốc độ nói</h4>
          <p class="select">
            <select class="budget" v-model="data.speed">
...
export default {
        ...
        .post(
          ...
          }),
          {
            headers: {
              ...
              apikey: "Wt94cYZFmKZavqjrF4WYQ63cHTLMJhNT"
            }
          }
        )
        .then(r => {
  ...
  //       Authorization: "Wt94cYZFmKZavqjrF4WYQ63cHTLMJhNT"
  //     };
  //     axios
  //       .post("https://api.zalo.ai/v1/tts/synthesize", this.data, {
  //         headers: headers
  //       })
  //       .then(response => {
